...
// **********************  3  ************************** 
if (empty($Error)) {
    $tinggibadan_1 = $tinggibadan / 100;
    $bmi = $beratbadan / ($tinggibadan_1)**2;
        if ($bmi <= 18.4) {
            $status = "Underweight";
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <p> Hasil Perhitungannya : <?php echo $bmi ?>
                    <p> Hasil Status : <?php echo $status ?>
